...
export default function Page() {
    return (
        <div className="container">
          ...
          <p>
            Создайте пустой файл-флаг для начала обмена и установите признак только для чтения. Это позволит запустить бесконечный цикл загрузки справочника.
            Файл флаг не будет удаляться и Frontol будет иницировать загрузку каждые 3 секунды (зависит от ваших настроек).
          </p>
          <Image className="img-fluid rounded mx-auto d-block mb-3"
          ...
          <p>
            ...
            Таблица <strong>Remaind</strong> содержала около 2млн. записей и это уже заметно отразилось на скорости работы поиска в справочнике.
