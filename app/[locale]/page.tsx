  ...
  return (
        <div className="container">
          ...
          <p>
            ...
            <a href="https://www.ibase.ru/45-ways-to-improve-firebird-performance-russian/"> длинную пишущую
              транзакцию</a>.
          ...
          <p>
            <code>
              SELECT FIRST 10 REMAINID, SUM(IIF(DTYPE = 0, DELTA, 0))AS SUMMA0, SUM(IIF(DTYPE = 1, DELTA, 0)) AS
              SUMMA1 <br/>
              FROM REMAIND RD <br/>
          ...
          <p>
            ...
            То есть мы знаем какая информация содержится в базе данных каждой кассы и выгружаем только измененные
            данные.
